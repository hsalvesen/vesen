export const commandHelp = {
  ...
  exit: `<span style="color: var(--theme-cyan); font-weight: bold;">exit</span> : Closes the terminal session. Attempts to close window, then triggers shutdown sequence.<br><span style="color: var(--theme-yellow); font-weight: bold;">Usage:</span> exit`,
